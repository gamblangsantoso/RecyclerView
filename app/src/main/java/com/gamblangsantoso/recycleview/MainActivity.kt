...
import com.gamblangsantoso.recycleview.adapter.AdapterTeamBola
import com.gamblangsantoso.recycleview.databinding.ActivityMainBinding
import com.gamblangsantoso.recycleview.model.Pemain
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listPemain.add(Pemain("Thibaut Courtoius", R.drawable.courtois,"Penjaga Gawang", "2.00 m", "Bree(Belgia)", "11 Mei 1992"))
